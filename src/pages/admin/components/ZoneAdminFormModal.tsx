...
import type { ZoneAdmin, NewZoneAdminForm } from "../../../types/zone";

interface ZoneAdminFormModalProps {
  admin?: ZoneAdmin | null;
  onSave: (form: NewZoneAdminForm) => void;
  onClose: () => void;
}

export default function ZoneAdminFormModal({ admin, onSave, onClose }: ZoneAdminFormModalProps) {
  const [form, setForm] = useState<NewZoneAdminForm>({
    ...
    >
      <div className="bg-white rounded-xl p-6 w-96 shadow-lg" dir="rtl">
        <h2 className="text-base font-semibold text-gray-800 mb-5">
          {admin ? "ویرایش مدیر زون" : "افزودن مدیر زون جدید"}
        </h2>
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-400 mt-1.5">
            برای ورود مدیر زون با کد یکبارمصرف (OTP) استفاده می‌شود
          </p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            {admin ? "ذخیره تغییرات" : "ثبت مدیر زون"}
          </button>
          <button
            onClick={onClose}
